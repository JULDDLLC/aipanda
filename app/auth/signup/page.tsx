...
import { ArrowLeft, Mail, Lock, UserPlus, AlertTriangle } from 'lucide-react';
...
export default function Signup() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        toast.success('Account created successfully! Welcome your Panda Awaits!');
    ...
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-24">
        ...
        >
          ...
          <div className="glass rounded-3xl p-8">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold gradient-text mb-2">Join the Adventure</h1>
              <p className="text-white/80">Create your account to start your panda journey</p>
            </div>
